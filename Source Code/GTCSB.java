...
public class GTCSB extends JFrame {
	...
	public void WantToDeleteFile(int fn, int cn)
	{
		int a=JOptionPane.showConfirmDialog(null, "For cost reduction, you should delete file:"+fn+" from cloud:"+cn+". Do you want to delete the file?");  
	...
	public void DeleteFile(int fn, int cn)
	{
		if(cn==1)
		{
			try 
	        {
	            ...
	            String query2 = "DELETE FROM cloud1 WHERE File_Number='"+fn+"'";
		...
		if(cn==2)
		{
			try 
	        {
	            ...
	            String query2 = "DELETE FROM cloud2 WHERE File_Number='"+fn+"'";
		...
		JOptionPane.showMessageDialog(null, new JLabel("File Number "+fn+" successfully deleted from Cloud"+cn+" server.", JLabel.CENTER), "Output", JOptionPane.PLAIN_MESSAGE);
	}
	...
	public GTCSB() {
		...
		txtGtcsbMinimumCost.setFont(new Font("Cambria", Font.BOLD, 36));
		...
		txtGtcsbMinimumCost.setBounds(365, 65, 570, 50);
		contentPane.add(txtGtcsbMinimumCost);
		
		textField_2 = new JTextField();
		textField_2.setText("Cloud Service Provider");
		textField_2.setForeground(Color.WHITE);
		textField_2.setFont(new Font("Cambria", Font.BOLD, 22));
		textField_2.setEditable(false);
		textField_2.setColumns(10);
		textField_2.setBorder(null);
		textField_2.setBackground(Color.DARK_GRAY);
		textField_2.setBounds(475, 160, 240, 35);
		contentPane.add(textField_2);
		
		final JComboBox comboBox = new JComboBox();
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Cloud 1", "Cloud 2"}));
		comboBox.setFont(new Font("Cambria", Font.BOLD, 18));
		comboBox.setBounds(727, 160, 95, 30);
		...
		btnNewButton.setFont(new Font("Cambria", Font.BOLD, 22));
		btnNewButton.setBorder(null);
		btnNewButton.setBackground(new Color(65, 105, 225));
		btnNewButton.setBounds(460, 215, 380, 50);
		...
		btnRunGtcsbMin.setFont(new Font("Cambria", Font.BOLD, 22));
		btnRunGtcsbMin.setBorder(null);
		btnRunGtcsbMin.setBackground(new Color(65, 105, 225));
		btnRunGtcsbMin.setBounds(460, 290, 380, 50);
